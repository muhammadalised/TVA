...
SUPPORTED_SCHEMA = 'dtlr.handwriting-bigram-tokenizer.v2'
...
class HandwritingBigramTokenizer:
    ...
    def load_model(
        ...
        *,
        ...
        if model.get('schema_version') != SUPPORTED_SCHEMA:
            raise ValueError('unsupported handwriting-bigram tokenizer schema')
        ...
        for index in range(len(text) - 1, -1, -1):
            ...
            if len(pair) == 2 and pair in self._bigram_rows:
                ...
                segment = {
                    ...
                    'utility': row['utility'],
                    'n_exact_alignment': row['n_exact_alignment'],
                    'exact_alignment_connected_rate': (
                        row['exact_alignment_connected_rate']
                    ),
                }
